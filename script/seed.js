      ...
      schedule: [
        {
          week: 1,
          activities: [
            { day: 'Monday', activity: 'Run', plan: '5K', planId: 1},
            { day: 'Tuesday', activity: 'Lift', plan: 'deadlifts', planId: 12 },
            { day: 'Wednesday', activity: 'Rest', },
            { day: 'Thursday', activity: 'Run', plan: '1k', planId: 3 },
            { day: 'Friday', activity: 'Lift', plan: 'Squats', planId: 11 },
            { day: 'Saturday', activity: 'Test Day', plan: '2000 m row', planId: 22 },
        ...
        },
        {
          ...
          activities: [
            ...
            { day: 'Tuesday', activity: 'Lift', plan: 'deadlifts', planId: 12 },
            { day: 'Wednesday', activity: 'Rest',  },
            { day: 'Thursday', activity: 'Run', plan: '3k', planId: 2 },
            { day: 'Friday', activity: 'Lift', plan: 'squats', planId: 11 },
            { day: 'Saturday', activity: 'Test Day', plan: '1000 m ski', planId: 21 },
            { day: 'Sunday', activity: 'Rest', },
          ],
        },
        {
          week: 3,
          activities: [
            { day: 'Monday', activity: 'Run', planId: 1 },
