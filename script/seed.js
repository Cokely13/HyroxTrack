      ...
      schedule: [
        {
          week: 1,
          activities: [
            { day: 'Monday', activity: 'Run', plan: '5K' },
            { day: 'Tuesday', activity: 'Lift', plan: 'deadlifts' },
            { day: 'Wednesday', activity: 'Rest', },
            { day: 'Thursday', activity: 'Run', plan: '1k' },
            { day: 'Friday', activity: 'Lift', plan: 'Squats' },
            { day: 'Saturday', activity: 'Test Day', plan: '2000 m row' },
        ...
        },
        {
          ...
          activities: [
            ...
            { day: 'Tuesday', activity: 'Lift', plan: 'deadlifts' },
            { day: 'Wednesday', activity: 'Rest',  },
            { day: 'Thursday', activity: 'Run', plan: '3k' },
            { day: 'Friday', activity: 'Lift', plan: 'squats' },
            { day: 'Saturday', activity: 'Test Day', plan: '1000 m ski' },
            { day: 'Sunday', activity: 'Rest', },
          ],
        },
        {
